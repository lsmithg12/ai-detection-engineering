...
**Detections deployed**: 8 (+ 1 in monitoring, + 1 in progress)
**Techniques covered**: 8 / 21 (38%)
**Intel sources**: Fawkes C2 (21 techniques), Scattered Spider/UNC3944 (20 techniques)
**Pipeline**: 6 deployed by Patronus, 3 manually deployed, 1 awaiting rework (T1055.001)
...
| Privilege Escalation (TA0004) | 5 | 1 | 1 | 1 | 2 |
...
| Technique | Sub | Name | Fawkes Cmd | Status | Rule File |
|---|---|---|---|---|---|
| T1055 | .001 | Process Injection: CreateRemoteThread | `vanilla-injection` | 🔨 In progress (F1=0.667) | [t1055_001.yml](../detections/privilege_escalation/t1055_001.yml) | [F+SS] |
...
| Technique | Sub | Name | Fawkes Cmd | Status | Rule File |
|---|---|---|---|---|---|
| T1055 | .001 | Process Injection | `vanilla-injection` | 🔨 In progress | — (see Priv Esc) |
